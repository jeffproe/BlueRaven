		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
			...
			builder.Entity<Post>().HasData(
				new Post
				{
					...
					BlogId = "blog1",
					Title = "First post",
					Content = "<p>Bacon ipsum dolor amet doner drumstick swine prosciutto. Swine boudin chuck tongue flank beef venison. Turducken strip steak beef ribs boudin. Pastrami jowl pork loin tri-tip. Ham hock biltong buffalo, pork short ribs spare ribs turducken strip steak prosciutto swine porchetta venison bresaola tongue doner. Porchetta bresaola pork chop venison. Boudin picanha burgdoggen drumstick meatball pork chop cow cupim shoulder tenderloin turducken filet mignon.</p><p><img src=\"/assets/img/raven.png\" alt=\"Blue Raven logo\" height=\"100\"></p><p>Fatback sausage chicken spare ribs, rump pork chop picanha strip steak buffalo. Burgdoggen beef frankfurter, spare ribs hamburger pork loin alcatra pork belly doner ground round biltong. Strip steak short loin leberkas ball tip salami brisket drumstick spare ribs. Ham bacon buffalo bresaola, short loin cupim flank rump pastrami tenderloin porchetta venison ball tip burgdoggen t-bone. Swine hamburger pork prosciutto pig pork belly jerky venison flank shoulder bacon pancetta. Salami pork chop rump, biltong kielbasa filet mignon pig.</p><p>Ball tip burgdoggen bresaola pancetta. Biltong pork loin buffalo, hamburger flank beef ribs shankle pig ground round ball tip. Pork loin kevin beef ribs turducken, flank ham hock short loin cupim beef t-bone ribeye ground round pig fatback. Kevin salami beef swine. Flank pig burgdoggen sirloin.</p>",
					Author = "Me",
					IsPublished = true,
